    m "Chào buổi sáng, [player]!{nw}"
    $ _history_list.pop()
    menu:
        m "Chào buổi sáng, [player]!{fast}"

        "Chào buổi sáng, [m_name]!":
        m "Ehehehe!"
        m "Great morning, isn't it?"
        m "Do you need an explanation of the phrase we just spoke, [player]?"
        m "Alright! 'Chào' is the basic go-to Vietnamese greeting for 'hello'!"
        m "As seen in the common 'xin chào', for example."
